  ...
  return (
    <AdminShell active="/admin/analytics">
      <div className="mx-auto max-w-[1500px]">
        <Link href="/admin/analytics" className="inline-flex items-center gap-2 text-sm font-black text-emerald-300"><ArrowLeft size={16} />All sessions</Link>
