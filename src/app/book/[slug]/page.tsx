  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="container-shell py-10">
        <div className="mb-7 max-w-3xl"><p className="text-sm font-black text-[var(--brand)]">SOLICITAR AGENDAMENTO</p><h1 className="mt-2 text-3xl font-black tracking-tight">Agendar {service.name}</h1><p className="mt-3 text-sm leading-6 text-[var(--muted)]">Você está solicitando o serviço de {business.name}. O profissional analisa a solicitação antes de aceitar. A taxa de agendamento VeroTask será cobrada e o valor do serviço é pago diretamente ao profissional.</p></div>
