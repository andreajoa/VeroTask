  ...
  return (
    <footer className="border-t border-[var(--line)] bg-white py-12">
      <div className="container-shell grid gap-10 lg:grid-cols-[1.2fr_repeat(4,1fr)]">
        <div>
          <Link href={localePath(locale, "/")} className="inline-flex items-center gap-2 text-xl font-black"><span className="grid h-9 w-9 place-items-center rounded-xl bg-[var(--brand-strong)] text-emerald-200"><BadgeCheck size={20} /></span>VeroTask</Link>
