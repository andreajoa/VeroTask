    ...
    <footer className="border-t border-[var(--line)] bg-white py-12">
      <div className="container-shell grid gap-10 lg:grid-cols-[1.2fr_repeat(4,1fr)]">
        <div>
          ...
          <p className="mt-4 max-w-sm text-sm leading-6 text-[var(--muted)]">Trusted local services with a separate VeroTask booking fee, evidence-backed completion, customer protection and a clearer record when something goes wrong.</p>
