  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200/90 bg-white/95 backdrop-blur-xl">
      <div className="container-shell flex min-h-[70px] items-center justify-between gap-4">
        ...
        <nav className="hidden items-center gap-6 text-sm font-bold text-slate-700 lg:flex" aria-label="Primary navigation">
        ...
        <div className="flex items-center gap-2">
          <div className="hidden rounded-xl border border-slate-300 bg-slate-50 p-1 text-xs font-black sm:flex" aria-label="Language selector">
