...
const privacy = {
  en: {
    ...
    sections: [
      ...
      ["Email engagement", "When a user has opted in to promotional email, VeroTask may record delivery, first reported open and primary call-to-action click events for campaign measurement and follow-up. Open events can be affected by email privacy proxies and are treated as approximate engagement signals. Transactional messages remain necessary for account, booking, payment and security operations."],
  ...
  "pt-br": {
    ...
    sections: [
      ...
      ["Engajamento por e-mail", "Quando a pessoa autoriza e-mails promocionais, a VeroTask pode registrar entrega, primeira abertura reportada e clique no principal botão da campanha para medir engajamento e follow-up. Aberturas podem ser afetadas por proxies de privacidade dos provedores de e-mail e são tratadas como sinal aproximado. Mensagens transacionais continuam necessárias para conta, reserva, pagamento e segurança."],
