  ...
  const { error } = await resend.emails.send({
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:560px;margin:auto;color:#13231d">
        ...
        <p>If this request is authorized, use the button below. After verification, finish the provider profile, services and availability before accepting bookings. Customers pay the service price directly to the professional; VeroTask charges its booking fee separately.</p>
